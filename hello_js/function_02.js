// JS 에서는 변수, 상수, 함수는 사용하기 전에 먼저 선언하라
...
// prettier가 적요이 안된다면 다음과 같이 선언 할 수 있다
...
const ret5 = 리턴함수3();
console.log("return3",ret5);

// 매개변수가 있고 return 이 있는 화살표 함수
const 리턴함수44 = (숫자1) => {
    return 숫자1 * 숫자1;
}
const 리턴함수4 = (숫자1) => 숫자1*숫자1;

let ret4 = 리턴함수4(7);
console.log("return4 (7)", ret4);
